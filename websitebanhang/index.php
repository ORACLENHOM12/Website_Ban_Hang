...
<div class="logo">
	...
	<ul>
		...
		if(isset($_SESSION['username'])){?>
			...
			<li class="dangnhap" style="margin-left: 200px"><a>Xin chào,<?php echo ($_SESSION['username'])  ?></a></li>
			<li class="giohang"><a href="index.php?xem=giohang"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Giỏ hàng</a></li>
			<li class="dangky" ><a href="dangxuat.php"><i class="fa fa-sign-out" aria-hidden="true"></i> Đăng Xuất</a></li>
			<?php
		}else{
		...
		?>
			...
			<li class="giohang"><a href="index.php?xem=giohang"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Giỏ hàng</a></li><?php } ?>
		</ul>
</div>
	<?php
