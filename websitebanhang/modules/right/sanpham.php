...
?>
			...
			<p align="left" style="background: #ee145b;padding: 14px;color: aliceblue;font-size: 19px;font-family: Segoe, Segoe UI, DejaVu Sans, Trebuchet MS, Verdana,' sans-serif';margin-left: 20px;" >TẤT CẢ SẢN PHẨM</p>
			<div class="sanpham">
				<ul>
					<?php
