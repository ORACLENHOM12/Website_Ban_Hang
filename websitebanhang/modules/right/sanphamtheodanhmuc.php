<?php
$sql="select * from sanpham where IDDongSP='$_GET[id]'";
...
?>
			...
			<p align="left" style="background: #ee145b;padding: 3px;color: aliceblue;font-size: 19px;font-family: Segoe, Segoe UI, DejaVu Sans, Trebuchet MS, Verdana,' sans-serif';margin-left: 20px;" ><?php echo($dong['TenDongSP'])?></p>
			<?php }?>
			<div class="sanpham">
				<ul>
				<?php
