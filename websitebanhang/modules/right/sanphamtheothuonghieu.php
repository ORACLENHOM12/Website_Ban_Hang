...
?>
			...
			<p align="left" style="background: #ee145b;padding: 14px;color: aliceblue;font-size: 19px;font-family: Segoe, Segoe UI, DejaVu Sans, Trebuchet MS, Verdana,' sans-serif';margin-left: 20px;" ><?php echo($dong['TENTHUONGHIEU'])?></p>
			<?php }?>
			<div class="sanpham">
				<ul>
				<?php
